...
namespace LCC_ENROLLMENT_SYSTEM.Components
{
    public partial class UpdateSeniorHighEnrollment : Form
    {
        ...
        private void LoadData()
        {
            ...
            comboBoxAdvisers.SelectedIndex = advisers.IndexOf(advisers.Where(a => a.Id == enrollment.adviserId).First());
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AppDbContext db = new();
            // add new enrollment
            Enrollment enrollment = db.Enrollments.Find(this.enrollmentId);
        ...
        private void btnNewAdvisers_Click(object sender, EventArgs e)
        {
